  ...
  return (
    <div className="my-properties">
      <div className="list-header">
        ...
        <button className="btn primary" onClick={openAdd}><span className="ico">＋</span> Add New Property</button>
      </div>
      ...
      {showAdd && <AddPropertyModal onClose={closeAdd} onSubmit={handleSubmit} />}
    </div>
  );
};
